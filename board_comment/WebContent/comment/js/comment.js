...
function addComment(){
	...
	var name = documnet.addForm.name.value;
	...
	var params = "num=" + encodeURIComponent(num) + "&" +
	"name=" + encodeURIComponent(name) + "&" + "content=" + encodeURI(content);
...
function updateComment(){
	...
	var params = "id=" + encodeURIComponet(id)+"&"+
			"name=" + encodeURIComponent(name) +"&" +
			"content=" + encodeURIComponent(content) +"&" +
			"regdate=" + encodeURIComponent(regdate);
	new ajax.xhr.Request('/board_comment/comment/update.do',params,updateResult,'POST');
}
...
function viewUpdateForm(commentId){
	var commentDiv = document.getElementById('c'+commendId);
...
function hideUpdateForm(){
	var updateFormDiv = comment.getElementById('commentUpdate');
	updateFormDiv.style.disply = 'none';
	updateFormDiv.parentNode.removeChild(updateFormDiv);
